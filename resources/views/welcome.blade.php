<x-public-layout>
    ...
    <section class="bg-brand">
        <div class="max-w-4xl mx-auto px-4 py-16 text-center">
            ...
            <h1 class="font-display font-extrabold text-4xl sm:text-5xl text-white leading-tight mb-3">Grosir Rokok &amp;
            </h1>
            <p class="font-display font-semibold text-base sm:text-lg text-cream/80 tracking-wide mb-8">Murah Tenan</p>

            @if ($setting)
                <div
                    class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-sm text-cream/90 mb-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                        @foreach ($category->products as $product)
                            <div class="bg-white rounded-xl border border-latar overflow-hidden">
                                <div class="aspect-square bg-latar relative">
